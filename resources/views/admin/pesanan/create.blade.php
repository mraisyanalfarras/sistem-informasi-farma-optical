        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-gradient-primary text-white py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 opacity-8">Silakan isi form di bawah ini dengan lengkap</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('pesanan.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-floating mb-3">
                                            <select name="frame_id" id="frame_id" class="form-select @error('frame_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($frames as $frame)
                                                    <option value="{{ $frame->id }}" data-harga="{{ $frame->harga_frame }}" {{ old('frame_id') == $frame->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-floating mb-3">
                                            <select name="lensa_id" id="lensa_id" class="form-select @error('lensa_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($lensas as $lensa)
                                                    <option value="{{ $lensa->id }}" data-harga="{{ $lensa->harga_lensa }}" {{ old('lensa_id') == $lensa->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="card shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-floating mb-3">
                                            <input type="date" name="tgl_pesan" class="form-control @error('tgl_pesan') is-invalid @enderror" value="{{ old('tgl_pesan', date('Y-m-d')) }}" required>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="date" name="tgl_selesai" class="form-control @error('tgl_selesai') is-invalid @enderror" value="{{ old('tgl_selesai') }}">
                                        ...
                                        <div class="form-floating">
                                            <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" style="height: 120px">{{ old('catatan') }}</textarea>
                                            <label>Catatan</label>
                                            @error('catatan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="card shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        <input type="text" id="total_harga" class="form-control form-control-lg text-end fw-bold" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
